...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/02/08 13:03:25 by embailla          #+#    #+#              #
#    Updated: 2016/02/25 17:07:47 by embailla         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	  ...
	  ft_lstiter.c ft_lstmap.c ft_abs.c ft_strup.c ft_strlow.c ft_lstadd_end.c
